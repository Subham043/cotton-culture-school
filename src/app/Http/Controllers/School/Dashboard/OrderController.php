...
class OrderController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('school.order.paginate')->with([
            'data'=> $data,
            'cart'=> $this->cart(),
    ...
    public function detail($id) {
        ...
        return view('school.order.detail')->with([
            'data'=> $data,
            'cart'=> $this->cart(),
            'cart_total'=> $this->cart_total(),
        ]);
    ...
    public function place_order(OrderRequest $request)
    {
        ...
        if($request->mode_of_payment==PaymentMode::COD->value){
            ...
            return response()->json([
                ...
                'link' => route('school_order.detail.get', $order->id),
            ], 201);
        }
        ...
        return response()->json([
            ...
            'link' => route('school_order.make_payment.get', $order->id),
        ], 201);
    }
    ...
    public function make_payment($id) {
        ...
        return view('school.order.payment')->with([
            'data'=> $data,
            'cart'=> $this->cart(),
            'cart_total'=> $this->cart_total(),
        ]);
    ...
    public function verify_payment(VerifyPaymentRequest $request, $id) {
        ...
        if($verify){
            ...
            return response()->json([
                'message' => 'Order completed successfully.',
                'link' => route('school_order.detail.get', $data->id),
            ], 201);
        }
        return response()->json([
    ...
    public function edit_order($id){
        ...
        return view('school.order.order_edit')->with([
