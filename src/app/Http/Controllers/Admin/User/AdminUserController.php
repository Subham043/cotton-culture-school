...
class AdminUserController extends Controller
{
    ...
    protected function query(){
        return User::where('id', '!=' , Auth::user()->id)->where("role" , Role::ADMIN->value)->orderBy('id', 'DESC');
    }
    ...
    public function edit($id) {
        ...
        return view('admin.user.admin.update')->with('data',$data);
    }
    ...
    public function view(Request $request) {
        ...
        return view('admin.user.admin.paginate')->with('data', $data);
    }
