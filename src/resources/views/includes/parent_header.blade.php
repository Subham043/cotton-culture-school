            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart" aria-labelledby="page-header-cart-dropdown">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                                <a href="{{route('parent_product_detail', $v->product->id)}}" class="text-reset">{{$v->product->name}}</a>
                                            </h6>
                                        ...
                                        <div class="ps-2">
                                            <a href="{{route('parent_edit_cart', $v->id)}}" type="button" title="edit" class="btn btn-icon btn-sm btn-ghost-primary"><i class="ri-pencil-fill fs-16"></i></a>
                                            <a href="{{route('parent_delete_cart', $v->id)}}" type="button" title="delete" class="btn btn-icon btn-sm btn-ghost-danger"><i class="ri-close-fill fs-16"></i></a>
                                        </div>
                                        <div class="px-2">
                        ...
                        <div class="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border" id="checkout-elem">
                            ...
                            <a href="{{route('checkout_cart')}}" class="btn btn-success text-center w-100">
                                Checkout
                            </a>
                        </div>
                    </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{route('parent_profile')}}"><i
                                class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Profile</span></a>

                        <a class="dropdown-item" href="{{ route('parent_signout') }}"><i
