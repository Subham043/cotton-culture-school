...
<div class="page-content">
    <div class="container-fluid">
        ...
        @include('includes.breadcrumb', ['page'=>'Cart', 'page_link'=>route('school_dashboard'), 'list'=>['Edit']])
                                                    ...
                                                    <div class="mt-xl-0 mt-5">
                                                        <div class="d-flex">
                                                            <div class="flex-grow-1">
                                                                <h4>{{$cart_detail->product->name}}</h4>
                                                                <div class="hstack gap-3 flex-wrap">
                                                                    <div class="text-muted">Category : <span class="text-body fw-medium">{{$cart_detail->product->category->name}}</span>
                                                                    </div>
                                                                    <div class="vr"></div>
                                                                    <div class="text-muted">Gender : <span class="text-body fw-medium">{{$cart_detail->product->gender}}</span>
                                                                    </div>
                                                                    <div class="vr"></div>
                                                                    <div class="text-muted">Published : <span class="text-body fw-medium">{{$cart_detail->product->created_at->diffForHumans()}}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="p-2 border border-dashed rounded">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            ...
                                                                            <h5 class="mb-0">&#8377; {{$cart_detail->product->price}}</h5>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="p-2 border border-dashed rounded">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            ...
                                                                            <h5 class="mb-0">{{$cart_detail->product->schoolAndclass->school->name}}</h5>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="p-2 border border-dashed rounded">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            ...
                                                                            <h5 class="mb-0">{{$cart_detail->product->schoolAndclass->class->name}}</h5>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="mt-4 text-muted">
                                                            ...
                                                            <p>{{$cart_detail->product->brief_description}}</p>
                                                        </div>
                                                        ...
                                                        <div class="product-content mt-5">
                                                            ...
                                                            <div class="tab-content border border-top-0 p-4" id="nav-tabContent">
                                                                <div class="tab-pane fade show active" id="nav-speci" role="tabpanel" aria-labelledby="nav-speci-tab">
                                                                    <div class="table-responsive">
                                                                        <table class="table mb-0">
                                                                            <tbody>
                                                                                @foreach($cart_detail->product->specification as $v)
                                                                                <tr>
                                                                ...
                                                                <div class="tab-pane fade" id="nav-detail" role="tabpanel" aria-labelledby="nav-detail-tab">
                                                                    <div>
                                                                        {!!$cart_detail->product->detailed_description!!}
                                                                    </div>
                                                                </div>
                                                                <div class="tab-pane fade" id="nav-refer" role="tabpanel" aria-labelledby="nav-refer-tab">
                                                                    <div>
                                                                        <iframe loading="lazy" src="https://www.youtube.com/embed/{{$cart_detail->product->youtube_video_id}}" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen="" style="width: 100%; height: 450px;" frameBorder="0"></iframe>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="card-title mb-0">Cart Item ({{$cart_detail->product->name}}) Detail</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                            ...
                                            <div class="row align-items-end justify-content-between">
                                                <div class="col-lg-12 md-12">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" id="kid" readonly disabled placeholder="Enter Kid" value="{{$cart_detail->kid->name}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-12">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="quantity" placeholder="Enter Quantity" value="{{$cart_detail->quantity}}">
                                            </div>
                                        </div>
                                        @foreach($cart_detail->product->units as $k=>$v)
                                        <div class="col-xxl-12">
                                            <div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="hstack gap-2 justify-content-end">
                                                <button type="submit" class="btn btn-primary" id="submitBtn">Update Cart Item</button>
                                            </div>
                                        </div>
                                        <!--end col-->
                                    </div>
...
const cart_field = @json(json_decode($cart_detail->units));
...
.addField('#quantity', [
  ...
  .onSuccess(async (event) => {
    ...
    submitBtn.innerHTML = "Updating Cart Item ..."
    ...
    try {
        ...
        const response = await axios.post('{{route('school_update_cart', $cart_detail->id)}}', formData)
