...
<div class="page-content">
    <div class="container-fluid">
        ...
        @include('includes.breadcrumb', ['page'=>'Checkout', 'page_link'=>route('school_dashboard'), 'list'=>['Checkout']])
                                            ...
                                            <div class="mt-4">
                                                <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        ...
                                                        <a href="{{route('school_address.create.get')}}" class="btn btn-sm btn-success mb-3">
                                                            Add Address
                                                        </a>
                                                    </div>
                                                </div>
                                                    ...
                                                    @if(count($address)>0)
                                                        ...
                                                        <div class="col-lg-4 col-sm-6">
                                                            ...
                                                            <div class="d-flex flex-wrap p-2 py-1 bg-light rounded-bottom border mt-n1">
                                                                <div>
                                                                    <a href="{{route('school_address.update.get', $v->id)}}" class="d-block text-body p-1 px-2"><i class="ri-pencil-fill text-muted align-bottom me-1"></i>
                                                                        Edit</a>
                                                                </div>
                                                                <div>
                                                                    <button type="button" data-link="{{route('school_address.delete.get', $v->id)}}" class="d-block btn text-body p-1 px-2 remove-item-btn"><i class="ri-delete-bin-fill text-muted align-bottom me-1"></i>
                                                                        Remove</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <table class="table table-borderless align-middle mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-15"><a href="{{route('school_product_detail', $v->product->id)}}" class="text-dark">{{$v->product->name}}</a>
                                                    </h5>
...
async function placeOrderHandler(event) {
    ...
    try {
        ...
        const response = await axios.post('{{route('school_place_order')}}', formData)
