...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('includes.breadcrumb', ['page'=>'Kid', 'page_link'=>route('school_kid.paginate.get'), 'list'=>['Create']])
        <!-- end page title -->

        <div class="row" id="image-container">
            @include('includes.back_button', ['link'=>route('school_kid.paginate.get')])
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('school_kid.update.post', $data->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
