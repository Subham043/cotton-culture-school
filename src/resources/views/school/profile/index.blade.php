    ...
    <div class="container-fluid">
        ...
        <div class="position-relative mx-n4 mt-n4">
            <div class="profile-wid-bg profile-setting-img">
                <img src="{{ asset('admin/images/logo-main.png') }}" class="profile-wid-img" alt="">
            </div>
        </div>
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('school_profile_update')}}', formData)
...
.addField('#password', [
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        formData.append('refreshUrl','{{URL::current()}}')
        const response = await axios.post('{{route('school_profile_password_update')}}', formData)
        successToast(response.data.message)
    }catch (error){
