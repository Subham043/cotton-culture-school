...
<div class="page-content">
    <div class="container-fluid">
        ...
        @include('includes.breadcrumb', ['page'=>'Order Item', 'page_link'=>route('school_dashboard'), 'list'=>['Edit']])
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('school_update_order', $order_detail->id)}}', formData)
