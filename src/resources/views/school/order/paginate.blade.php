...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('includes.breadcrumb', ['page'=>'Order', 'page_link'=>route('school_order.paginate.get'), 'list'=>['List']])
        <!-- end page title -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <a href="{{route('school_order.detail.get', $item->id)}}" class="btn btn-sm btn-primary edit-item-btn">View Detail</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
