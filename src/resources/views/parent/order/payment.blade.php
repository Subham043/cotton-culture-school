...
<div class="page-content">
    <div class="container-fluid">
        ...
        @include('includes.breadcrumb', ['page'=>'Order', 'page_link'=>route('parent_dashboard'), 'list'=>['Payment']])
...
const verifyPayment = async (data) => {
    try {
        const response = await axios.post('{{route('order.verify_payment.get', $data->id)}}', data)
