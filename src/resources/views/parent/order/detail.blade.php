...
<div class="page-content">
    <div class="container-fluid">
        ...
        @include('includes.breadcrumb', ['page'=>'Order', 'page_link'=>route('parent_dashboard'), 'list'=>['Detail']])
            ...
            <div class="col-xxl-12">
                ...
                <div class="card">
                    <div class="text-center py-5">
                        ...
                        <h3 class="fw-semibold">Order ID: <a href="{{route('order.detail.get', $data->id)}}" class="text-decoration-underline">{{$data->id}}</a></h3>
                    </div>
                </div>
                @endif
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <h5 class="fs-16"><a href="{{route('parent_product_detail', $v->product->id)}}" class="link-primary">{{$v->product->name}}</a></h5>
