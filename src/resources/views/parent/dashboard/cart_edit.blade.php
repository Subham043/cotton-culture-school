...
<div class="page-content">
    <div class="container-fluid">
        ...
        @include('includes.breadcrumb', ['page'=>'Cart', 'page_link'=>route('parent_dashboard'), 'list'=>['Edit']])
...
.addField('#quantity', [
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('parent_update_cart', $cart_detail->id)}}', formData)
