...
<div class="page-content">
    <div class="container-fluid">
        ...
        @include('includes.breadcrumb', ['page'=>'Product', 'page_link'=>route('parent_dashboard'), 'list'=>[$product->name]])
                        ...
                        <div class="col-12">
                            <div class="row align-items-end justify-content-between">
                                ...
                                <div class="col-lg-3 md-3">
                                    <a href="{{route('kid.create.get')}}" class="btn btn-primary">Add Kid</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-12">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('parent_save_cart')}}', formData)
