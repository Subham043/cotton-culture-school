...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('includes.breadcrumb', ['page'=>'Banner Image', 'page_link'=>route('banner.paginate.get'), 'list'=>['List']])
        <!-- end page title -->

        <div class="row">

            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('banner.create.post')}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Banner Image Detail</h4>
                        </div><!-- end card header -->
                        <div class="card-body">
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn" data-link="{{route('banner.delete.get', $item->id)}}">Delete</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
